...
var Client = function (opts) {
  ...
  var domain = opts.domain ? opts.domain : 'aliyuncs.com';

  this.endpoint = `http://${opts.instance}.${opts.region}.${env}.${domain}/`;
  ...
  if (opts.hasOwnProperty('timeout') && typeof opts.timeout === 'number') {
