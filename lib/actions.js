 ...
 * @return {Object} 返回值
 */
exports.putRow = async function (name, condition, primaryKeys, columns, returnContent) {
  return this.request('PutRow', {
    table_name: name,
    row: serialize(primaryKeys, columns),
    condition: condition,
 ...
 * @return {Object} 返回值
 */
exports.getRow = async function (name, primaryKeys, columns, options) {
  var data = Object.assign({
    table_name: name,
    primary_key: serialize(primaryKeys),
 ...
 * @return {Object} 返回值
 */
exports.updateRow = function (name, primaryKeys, columns, condition, returnContent) {
  return this.request('UpdateRow', {
    table_name: name,
    row_change: serialize(primaryKeys, columns),
    condition: condition,
    // return_content: returnContent
  });
};
 ...
 * @return {Object} 返回值
 */
exports.deleteRow = function (name, primaryKeys, columns, deleteMarker, condition, returnContent) {
  return this.request('DeleteRow', {
    table_name: name,
    primary_key: serialize(primaryKeys, columns, deleteMarker), // only with primaryKeys
    condition: condition,
    return_content: returnContent
  });
};
